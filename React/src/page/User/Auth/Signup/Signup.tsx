  ...
  <div className="container h-full p-10">
    <div
      ...
      <div className="w-full">
        <div
          className="block rounded-lg bg-white shadow-xl dark:bg-neutral-800">
          <div className="g-0 xl:flex ">
            ...
            <div className="px-4 md:px-0 w-full xl:w-1/2">
              <div className="md:mx-6 md:p-12">
                ...
                <form>
                  <p className="my-4 text-2xl font-semibold">Register</p>
                  ...
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                      <input type="email" name="email" id="email" className="bg-gray-50  text-gray-900 sm:text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 focus:outline-none" placeholder="Nguyen Van A" />
                  </div>
                  ...
                  <div className="mb-12 pb-1 pt-1 text-center">
                    <button
                      ...
                      style={{
                        background: "linear-gradient(to right, #2cbcb2, #16cbcb, #16cbcb, #2cbcb2) "}}>
                    Register
                    </button>
            ...
            <div
              ...
              style={{background: "linear-gradient(to right, #2cbcb2, #25a9a9, #25a9a9, #2cbcb2)"}}>
