...
import { SigninForm, signinSchema } from "../../../../interface/Auth/auth";
import { yupResolver } from "@hookform/resolvers/yup";
import { Signins } from "../../../../api/Auth/Auth";
...
const Signin = () => {
  ...
  const onSubmits = async (data: SigninForm) => {
    console.log(122);
