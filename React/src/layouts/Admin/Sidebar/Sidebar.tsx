...
<div className="max-w-2xl mx-auto">
	...
	<aside className="w-64 fixed" aria-label="Sidebar">
		<div className="px-3 py-4 overflow-y-auto h-screen rounded bg-gray-100 dark:bg-gray-800">
          ...
          >
            ...
            {isDropdownOpen && (
					<ul  className=" py-2 space-y-2">
						<li>
						<Link to={config_Admin.products}
								className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700 pl-11">Sản Phẩm</Link>
						</li>
						<li>
						<Link to={config_Admin.category}
								className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700 pl-11">Danh mục sản phẩm</Link>
						</li>
						<li>
						<Link to={''}
								className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700 pl-11">Size</Link>
						</li>
            <li>
						<Link to={''}
								className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700 pl-11">Màu </Link>
						</li>
				...
				<Link to={''}
						...
						<span className="flex-1 ml-3 whitespace-nowrap">Giỏ hàng</span>
