            ...
            <div className="flex items-center  md:order-2">
              {name ? (
                <button
                  title="Đăng xuất"
                  onClick={hanldLogout}
                  className="bg-[#088178] px-3 py-2 mx-1 rounded-sm text-white hover:bg-[#0f9d93]"
                >
                  {name}
                </button>
              ) : (
                <div className="client hidden xl:block ">
                  <Link to={config.signin}>
                    {" "}
                    <button className="bg-[#088178] px-3 py-2 mx-1 rounded-lg text-white hover:bg-[#0f9d93]">
                      Login
                    </button>
                  </Link>
                  <Link to={config.signup}>
                    {" "}
                    <button className="bg-gray-100 px-3 py-2 mx-1 rounded-lg text-[#088178]">
                      {" "}
                      Register{" "}
                    </button>
                  </Link>
