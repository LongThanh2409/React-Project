...
return (
  <>
   <div className="bg-gray-200 pl-2 md:pl-10 pt-5 flex items-center cursor-pointer">
      <h1 className="bg-teal-500 hover:bg-teal-400 text-white px-3 py-2 rounded-md" onClick={showDrawer}>
        Danh mục sản phẩm
      </h1>
    
        <Drawer  title="Danh mục sản phẩm"  placement="left" onClose={onClose} open={open}>
